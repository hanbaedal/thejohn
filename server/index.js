...
const supportBoardRoutes = require("./routes/supportBoard");
const supportInquiryRoutes = require("./routes/supportInquiry");
...
app.get("/api/health/detail", async function (req, res) {
    ...
    if (isDbReady()) {
        try {
            ...
            const { getAdminStaffLoginIds } = require("./lib/staffOrderEnabled");
            ...
            payload.adminStaffLoginIds = await getAdminStaffLoginIds();
            payload.orderEnabledStaffLoginIds = payload.adminStaffLoginIds;
...
function setNoCacheGateHeaders(res, filePath) {
    ...
    if (
        ...
        base === "marketing-material-shared.js" ||
        base === "marketing-material-register.js" ||
        base === "marketing-material-list.js" ||
        base === "marketing-material.css" ||
        base === "manifest.json"
    ) {
